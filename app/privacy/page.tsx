...
export const metadata: Metadata = {
  title: 'Privacy Policy — insurancecalculators.app',
  description: 'Privacy policy for insurancecalculators.app — how we handle your data on our free insurance calculator suite.',
  alternates: { canonical: 'https://insurancecalculators.app/privacy' },
}
    ...
    <>
      ...
      <section className="bg-white dark:bg-[#0f172a] pt-8 pb-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <p className="text-xs text-gray-400 mb-8">Last updated: July 3, 2026</p>
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Information We Collect</h2>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                insurancecalculators.app does not collect, store, or transmit your financial information. All calculator inputs and outputs are processed entirely within your browser using JavaScript. Your numbers never leave your device or reach our servers.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                We use localStorage (not cookies) to save your calculator preferences and last inputs on your device. Google AdSense may set cookies for ad serving and measurement. You can control cookies through your browser settings. Our dark mode preference is stored in localStorage under the key &apos;ic-theme&apos;.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                insurancecalculators.app is not directed at children under 13. We do not knowingly collect personal information from children.
              </p>
            </div>
