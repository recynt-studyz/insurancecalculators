...
const tools = [
  ...
  { href: '/renters', label: 'Renters Insurance' },
  { href: '/term-vs-whole', label: 'Term vs Whole' },
  { href: '/deductible', label: 'Deductible Optimizer' },
]
...
export default function CalcNav() {
  ...
  const toggleDark = () => {
    ...
    try { localStorage.setItem('ic-theme', next ? 'dark' : 'light') } catch { /* ignore */ }
  }

  return (
    <nav aria-label="Insurance calculator navigation" className="px-4 sm:px-6 overflow-x-auto">
